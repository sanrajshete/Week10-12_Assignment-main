...
# Load the dataset
data = pd.read_csv('C:/Users/USER/Desktop/Microservices/data/breast_cancer.csv')
...
# Export model
joblib.dump(pipe, gzip.open('C:/Users/USER/Desktop/Microservices/model/model_binary.dat.gz', "wb"))
